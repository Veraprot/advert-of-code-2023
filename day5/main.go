...
func main() {
	...
	categories := strings.Split(string(output), "\n")

	fmt.Println(getLowerLocationNumber(categories, getSeedsPart1))
	fmt.Println(getLowerLocationNumber(categories, getSeedsPart2))
